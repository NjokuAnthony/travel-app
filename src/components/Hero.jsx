...
const Hero = () => {
  return (
    <div className='w-full h-screen relative'>
        ...
        <div className='absolute w-full h-full top-0 text-white p-4 justify-center text-center flex flex-col'>
            ...
            text-black bg-gray-100/90'>
                ...
                <div>
                    <button><AiOutlineSearch size={20} className='icons' style={{color: 'white'}} /></button>
                </div>
            </form>
        </div>
    </div>
